...
export default function UserPage() {
  return (
    <PageLayout variant="sidebar">
      <PageLayout.Aside>
        <Section>
          <Section.Header>사용자 메뉴</Section.Header>
        ...
        <Section>
          <Section.Header>통계</Section.Header>
        ...
        <Section>
          <Section.Header>최근 활동</Section.Header>
        ...
        <Section>
          <Section.Header>빠른 액션</Section.Header>
      ...
      <PageLayout.Main>
        <Section variant="card">
          <Section.Header>사용자 대시보드</Section.Header>
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mb-4">환영합니다!</h3>
              <p className="text-gray-600 mb-4">
                사용자 대시보드에 오신 것을 환영합니다. 여기서 계정 정보를 관리하고 활동을 확인할 수 있습니다.
              </p>
        ...
        <Section>
          <Section.Header>최근 게시글</Section.Header>
